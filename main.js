const dictionary = {
    '김': {
        ...
        end: ['기적 같은 주님의 사랑이 평생에 가득하시길 간절히 축복합니다.', '기다려온 소망의 열매가 삶에 풍성히 맺히길 늘 기도합니다.']
    },
    '이': {
    ...
    '전': {
        start: ['전능하신 하나님의 손길이 당신의 연약함을 강건케 하고,', '전심으로 주를 찾는 당신에게 하늘 보화가 열리는 기적이 임하며,'],
    ...
    '윤': {
        start: ['윤슬처럼 반짝이는 은혜의 물결이 당신의 마음을 적시고,', '우리와 함께하시는 임마누엘의 하나님을 깊이 경험하며,'],
        mid: ['윤택한 영혼의 복이 당신의 삶과 가정 위에 넘쳐나고,', '윤기 나는 믿음의 고백이 당신의 입술에서 끊이지 않아,'],
    ...
    '한': {
        ...
        mid: ['한마음으로 주를 섬기며 공동체에 활력을 불어넣고,', '한계가 없는 하나님의 축복이 당신의 삶에 쏟아져서,'],
