...
const fallbacks = {
    start: ['{char}로 시작하는 오늘 하루가 당신에게 큰 선물이 되고,', '{char}라는 소중한 이름 위에 주님의 축복이 가득 머물며,'],
    mid: ['{char}와 함께하는 모든 순간에 주님의 향기가 배어 나오고,', '{char}를 통해 일하실 하나님의 선하신 계획을 기대하며 걸어,'],
    end: ['{char}로 시작된 오늘의 고백이 주님께 기쁨이 되길 축복합니다.', '{char}의 삶이 하나님의 사랑을 전하는 예쁜 통로가 되길 원합니다.']
};
