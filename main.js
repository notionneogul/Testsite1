const dictionary = {
    ...
    '조': {
        ...
        mid: ['조화로운 삶의 고백을 통해 주변에 사랑을 널리 전하고,', '조금은 천천히 가더라도 주님과 발발맞추어 걷는 즐거움으로,'],
    ...
    '오': {
        start: ['오묘하신 하나님의 섭리가 당신의 삶을 가장 선한 길로 인도하고,', '오직 주님만이 내 삶의 주인 되심을 담대히 선포하며 시작하며,'],
        mid: ['오늘이라는 선물 속에서 주님과 함께 걷는 작은 천국을 경험하고,', '오래 참음과 온유함의 열매가 당신의 성품 속에서 예쁘게 맺혀서,'],
        end: ['오직 예수 그리스도의 은혜만이 당신의 삶에 가득하길 축복합니다.', '오늘보다 내일이 더 빛나는 주님의 자녀로 우뚝 서시길.']
    },
    '서': {
    ...
    '찬': {
        ...
        mid: ['참된 진리를 수호하며 타협하지 않는 믿음의 용기로 세상에 서고,', '찬물 한 그릇의 사랑도 잊지 않으시는 주님의 보상을 경험하며 살아서,'],
    ...
    '승': {
        start: ['승리의 깃발을 높이 들고 주님의 영광을 온 땅에 선포하며,', '승전보를 울리는 믿음의 군사처럼 당당하게 오늘을 시작하고,'],
        mid: ['승패를 넘어 주님과 함께 걷는 그 길 자체로 행복을 느끼며,', '승리하신 주님의 능력이 당신의 삶에 실재가 되어 나타나서,'],
        end: ['승리자에게 예비된 생명의 면류관을 얻는 복된 인생 되소서.', '승리하신 주님 손 꼭 잡고 날마다 천국을 맛보며 사시길 축원해요.']
    },
    '원': {
        start: ['원하는 모든 소망이 주님의 뜻 안에서 아름답게 열매 맺고,', '원대한 꿈을 품고 독수리처럼 날아오르는 믿음의 사람이 되어,'],
        mid: ['원수 앞에서도 상을 베푸시는 주님의 넉넉함을 날마다 경험하며,', '원동력이 되시는 성령님의 손길을 따라 기쁘게 순종하며 걸어서,'],
        end: ['원함보다 더 큰 것으로 채우시는 하나님의 은혜를 누리소서.', '원 없이 주님을 사랑하고 원 없이 축복받는 인생 되길 빌어요.']
    },
    '태': {
        start: ['태양보다 밝게 빛나는 주의 영광이 당신의 삶을 환히 비추고,', '태초부터 당신을 향해 계획하신 하나님의 사랑을 깊이 느끼며,'],
        mid: ['태산보다 높고 바다보다 깊은 주의 은혜 안에 머물러 살고,', '태풍 같은 시련 속에서도 주가 주시는 평안으로 넉넉히 이겨내어,'],
        end: ['태어난 보람을 주 안에서 발견하고 사명을 다하는 삶 되소서.', '태도가 신앙이 되어 삶의 모든 순간이 예배가 되길 축복합니다.']
    },
    '연': {
        start: ['연단된 정금처럼 당신의 믿음이 주님 앞에 보석같이 빛나고,', '연약한 우리를 강건케 하시는 주님의 능력을 날마다 의지하며,'],
        mid: ['연속되는 일상 속에서도 늘 새로운 주님의 은혜를 발견하고,', '연합하여 선을 이루시는 하나님의 놀라운 섭리를 찬양하며 살아서,'],
        end: ['연못가에 핀 꽃처럼 맑고 향기로운 주의 사람으로 남으소서.', '연기처럼 사라질 세상 것보다 영원한 것을 사모하며 살길 축복해요.']
    }
};
